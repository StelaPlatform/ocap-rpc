...
config :ocap_rpc, :btc,
  ...
  timeout: System.get_env("BTC_RPC_TIMEOUT", "5000") |> String.to_integer()
...
config :ocap_rpc, :eth,
  ...
  timeout: System.get_env("ETH_RPC_TIMEOUT", "5000") |> String.to_integer(),
...
config :ocap_rpc, :ipfs,
  ...
  timeout: System.get_env("IPFS_RPC_TIMEOUT", "5000") |> String.to_integer()
